...
export default function Header() {
    ...
    return (
        <header className='header'>
            <Link href='/'>
                <a className='header-login'><IconUser /> Login</a>
            </Link>
            <div className='header-wrapper-logo'><Logo /></div>
            ...
            <div className='header-navigation'>
                ...
                <div className='header-navigation__top'>
                    <Link href='/components/partnership/Partnership'>
                    ...
                    <Link href='/'>
                        <a className='header-navigation__top__item'><IconUser width='12' height='12'/> Login</a>
                    </Link>
                    <Link href='/'>
                ...
                <div className='header-navigation__bottom'>
                    <Link href='/'>
                        <a className='header-navigation__bottom__item'>Markets<Plus margin={'6px'}/></a>
                    </Link>
                    <Link href='/components/about/About'>
                        <a className='header-navigation__bottom__item'>About us<Plus margin={'6px'}/></a>
                    </Link>
                    <Link href='/'>
                        <a className='header-navigation__bottom__item'>Trader`s tools<Plus margin={'6px'}/></a>
                    </Link>
                    <Link href='/'>
                        <a className='header-navigation__bottom__item'>Education<Plus margin={'6px'}/></a>
                    </Link>
                    <Link href='/'>
                        <a className='header-navigation__bottom__item'>Why Orbit GTM<Plus margin={'6px'}/></a>
                    </Link>
                </div>
            </div>
        </header>
