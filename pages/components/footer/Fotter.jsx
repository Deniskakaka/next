    ...
    return(
        <footer className='footer'>
           ...
           <div className='footer-list-links'>
            ...
            <LinksFooter 
                arr={[
                    {text:'About company', link: '/components/about/About'}, 
                    {text:'Why Orbit GTM', link:'/'}, 
                    {text:'Company statement', link:'/'},
                    {text:'Contact us', link:'/components/contact-us/ContactUs'} , 
                    {text:'Partnership', link:'/components/partnership/Partnership'}]} 
                headling={'About us'}
            />
            <LinksFooter
                arr={[
            ...
            <LinksFooter
                arr={[
                    ...
                    {text:'News', link:'/'} , 
                    {text:'FAQ', link:'/'},
                    {text:'Risk management', link:'/components/risk-management/RiskManagement'},
                ]} 
                headling={'Education'}
            />
             <LinksFooter
           ...
           <div className='footer-wrapper-describe'>
                ...
                <div className='footer-description'>
                    <p>
                        Risk Warning: Trading Contracts For Difference and Foreign Exchange is highly speculative and carries a level
                        of risk that may not be suitable for all investors. You may lose some or all of your invested capital; therefore,
                        you should not speculate with the capital you cannot afford to lose. 
                    </p>
                    <p>
                        You should be aware of all the risks associated with trading Contracts For Difference and Foreign Exchange.
                        Please ensure you read our Terms and Conditions and Risk Disclosure Statement
                    </p>
