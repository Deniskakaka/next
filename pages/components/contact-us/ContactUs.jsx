            ...
            <section className='contact-us'>
                ...
                <div className='contact-us-describe'>
                    ...
                    <p className='contact-us-describe__text'>
                        Get in touch with us. You can contact us by filling in the form below. Simply provide us with your first name,
                        last name, email, country, phone number (including your country code) and your message.
                    </p>
                    <p className='contact-us-describe__text'>
                        Alternatively, you can get in touch with any of our departments on their relevant telephone numbers, fax numbers or email addresses. 
                    </p>
                    <button className='contact-us-describe__button'>Open an account</button>
                </div>
                <div className='contact-us-content'>
                    <div className='contact-us-content-wrapper'>
                        <h2 className='contact-us-content-wrapper__headling'>Contact details</h2>
                    ...
                    <form className='contact-us-form'>
                        ...
                        <span className='contact-us-form__error'>All fields are required</span>
                        <div className='wrapper-checkbox'>
                            <input type='checkbox' className='done' id='done' />
                            <label htmlFor='done'><span>I have read, understood and accepted the <a className='link'>Terms and conditions</a></span></label>
                        </div>
